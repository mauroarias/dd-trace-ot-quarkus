package quarkus.datadog.trace.bootstrap.instrumentation.api.ci;

import static quarkus.datadog.trace.bootstrap.instrumentation.api.ci.AppVeyorInfo.APPVEYOR;
import static quarkus.datadog.trace.bootstrap.instrumentation.api.ci.AzurePipelinesInfo.AZURE;
import static quarkus.datadog.trace.bootstrap.instrumentation.api.ci.BitBucketInfo.BITBUCKET;
import static quarkus.datadog.trace.bootstrap.instrumentation.api.ci.BuildkiteInfo.BUILDKITE;
import static quarkus.datadog.trace.bootstrap.instrumentation.api.ci.CircleCIInfo.CIRCLECI;
import static quarkus.datadog.trace.bootstrap.instrumentation.api.ci.GitLabInfo.GITLAB;
import static quarkus.datadog.trace.bootstrap.instrumentation.api.ci.GithubActionsInfo.GHACTIONS;
import static quarkus.datadog.trace.bootstrap.instrumentation.api.ci.JenkinsInfo.JENKINS;
import static quarkus.datadog.trace.bootstrap.instrumentation.api.ci.TravisInfo.TRAVIS;
