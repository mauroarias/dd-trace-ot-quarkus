package quarkus.datadog.trace.util;

import static quarkus.datadog.trace.util.AgentThreadFactory.AGENT_THREAD_GROUP;
import static quarkus.datadog.trace.util.AgentThreadFactory.AgentThread.TASK_SCHEDULER;
import static quarkus.datadog.trace.util.AgentThreadFactory.newAgentThread;
import static java.util.concurrent.TimeUnit.NANOSECONDS;

import quarkus.datadog.trace.util.AgentThreadFactory.AgentThread;
