package quarkus.datadog.trace.core.util;

import quarkus.datadog.trace.api.time.SystemTimeSource;
import quarkus.datadog.trace.api.time.TimeSource;
import quarkus.datadog.trace.util.MathUtils;
